...
- `legal/google-play-data-safety.md` — draft Google Play Data safety answers
...
These documents are a **source-backed implementation draft**, not a substitute for advice from a qualified Polish/EU lawyer. Do not publish or merge them as final until every `[[PLACEHOLDER]]` has been replaced and the blocking checklist is complete.
...
Last reviewed against the Moonveil repositories: **23 July 2026**.
